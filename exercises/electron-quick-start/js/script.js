...
function setAndFadeInProverbs() {
  ...
  $("#proverb1").text(proverb1.text()).hide().fadeIn(2000);
  $("#proverb2").text(proverb2.text()).hide().fadeIn(1000);
}
...
function displayMashup() {
  $("#mashup").text(mashup_groomed).hide().fadeIn(1000);
}
